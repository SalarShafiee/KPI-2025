...
if uploaded_file:
    try:
        ...
        elif "Tabelle2" in excel_file.sheet_names:
            df = pd.read_excel(uploaded_file, sheet_name="Tabelle2")
        else:
            st.error("The file must contain a sheet named 'Sheet2' or 'Tabelle2'.")
            st.stop()
